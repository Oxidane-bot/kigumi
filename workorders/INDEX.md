...
> 状态图例：READY=可派发 ｜ COMPLETED=已完成 ｜ NEEDS-DESIGN=先设计子工单 ｜ SCOPED=分阶段
...
|----|------|------|------|------|------|------|
| WO-01 | 配置 fail-closed | #11 #12 #19 | 1 | COMPLETED | 低 | 否 |
| WO-02 | init 文档对齐 | #2 | 1 | COMPLETED | 极低 | 否 |
| WO-03 | 有界等待超时 | #14 #15 #18 | 1 | COMPLETED | 低-中 | 否 |
| WO-05 | schema 版本化 | #21 | 1 | COMPLETED | 低 | 否 |
| WO-07 | agent 诊断 | #6 #7 | 1 | COMPLETED | 中 | 否 |
| WO-09 | 精简#1 共享物化器 | complexity | 1 | COMPLETED | 中 | **否** |
| WO-10 | 精简#3 静态脚手架 | complexity | 1 | COMPLETED | 低 | 否 |
| WO-11 | 文档对齐 | #24 #4 | 1 | COMPLETED | 极低 | 否 |
| WO-16 | single-flight 生命周期 | #20 | 2 | COMPLETED | 中 | 否 |
| WO-12 | 精简#2 key-decision 对象 | complexity | 2 | COMPLETED | 高 | **否** |
